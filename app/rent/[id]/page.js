...
export default function page() {
  ...
  useEffect(() => {
    const fetchProp = async () => {
      setLoading(true);
      try {
        const propertyData = await getPropById(id);
  ...
  const rentalFeatures = [
    { id: 1, title: 'Listed On', icon: images.listedOn, val: '1 Week' },
    // {id: 2, title: 'City' , val: ''},
    // {id: 3, title: 'City' , val: ''},
    { id: 4, title: 'Date available', val: DateAvalaibality },
    { id: 5, title: 'Type', val: PropertyType },
    { id: 6, title: 'Size', val: SquareFoot },
  ];
        ...
        {loading ? (
          ...
          <section>
            ...
            <section className='d-flex flex-column flex-md-row justify-content-between'>
              <article className='col-12 col-md-8'>
                ...
                <section>
                  ...
                  <article className='d-flex flex-wrap justify-content-between'>
                    {rentalFeatures.map(({ title, icon, val }) => (
              ...
              <aside className='col-12 col-md-3'></aside>
            </section>
          </section>
        )}
      </main>
